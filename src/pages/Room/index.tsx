...
export function Room() {
  ...
  async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
    if (!likeId) {
      await database.ref(`rooms/${params.roomId}/questions/${questionId}/likes`).push({
        authorId: user?.id
      });
    } else {
      await database.ref(`rooms/${params.roomId}/questions/${questionId}/likes/${likeId}`).remove();
    }
  }
              ...
              >
                {
                  ...
                  >
                    { question.likeCount ?? <span>10</span> }
